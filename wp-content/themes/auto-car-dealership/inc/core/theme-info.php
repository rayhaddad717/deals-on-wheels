	    ...
	    <div class="tab-sec">
			<div class="tab">
				<button class="tablinks" onclick="auto_car_dealership_open_tab(event, 'lite_theme')"><?php esc_html_e( 'Free Setup', 'auto-car-dealership' ); ?></button>
			  	...
			  	<button class="tablinks" onclick="auto_car_dealership_open_tab(event, 'free_pro')"><?php esc_html_e( 'Support', 'auto-car-dealership' ); ?></button>
			...
			<div id="free_pro" class="tabcontent">
				<div class="support-sec">
				  	<div class="col-2">
				  		<h4><span class="dashicons dashicons-star-filled"></span><?php esc_html_e('Pro Version', 'auto-car-dealership'); ?></h4>
						<p> <?php esc_html_e('To gain access to extra theme options and more interesting features, upgrade to pro version.', 'auto-car-dealership'); ?></p>
						<div class="info-link">
							<a href="<?php echo esc_url( AUTO_CAR_DEALERSHIP_BUY_NOW ); ?>" target="_blank"><?php esc_html_e('Get Pro', 'auto-car-dealership'); ?></a>
						</div>
				  	</div>
				  	<div class="col-2">
				  		<h4><span class="dashicons dashicons-cart"></span><?php esc_html_e('Pre-purchase Queries', 'auto-car-dealership'); ?></h4>
						<p> <?php esc_html_e('If you have any pre-sale query, we are prepared to resolve it.', 'auto-car-dealership'); ?></p>
						<div class="info-link">
							<a href="<?php echo esc_url( AUTO_CAR_DEALERSHIP_CONTACT ); ?>" target="_blank"><?php esc_html_e('Question', 'auto-car-dealership'); ?></a>
						</div>
				  	</div>

				  	<div class="col-2">
				  		<h4><span class="dashicons dashicons-admin-comments"></span><?php esc_html_e('Frequently Asked Questions', 'auto-car-dealership'); ?></h4>
						<p> <?php esc_html_e('We have gathered top most, frequently asked questions and answered them for your easy understanding. We will list down more as we get new challenging queries. Check back often.', 'auto-car-dealership'); ?></p>
						<div class="info-link">
							<a href="<?php echo esc_url( AUTO_CAR_DEALERSHIP_FAQ ); ?>" target="_blank"><?php esc_html_e('View FAQ','auto-car-dealership'); ?></a>
						</div>
				  	</div>

				  	<div class="col-2">
				  		<h4><span class="dashicons dashicons-sos"></span><?php esc_html_e('Support Queries', 'auto-car-dealership'); ?></h4>
						<p> <?php esc_html_e('If you have any queries after purchase, you can contact us. We are eveready to help you out.', 'auto-car-dealership'); ?></p>
						<div class="info-link">
							<a href="<?php echo esc_url( AUTO_CAR_DEALERSHIP_SUPPORT ); ?>" target="_blank"><?php esc_html_e('Contact Us', 'auto-car-dealership'); ?></a>
						</div>
				  	</div>
				</div>
			</div>
